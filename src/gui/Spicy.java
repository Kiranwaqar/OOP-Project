...
public class Spicy extends javax.swing.JFrame implements UserInputHandler {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Are there any ingredients or flavours you particularly dislike or prefer to avoid?");
 ...
 public void handleUserInput(String allergenInput, String proteinInput) {
      Ingredient[] chickenCurryIngredients = SpicyIngredient.chickenCurryIngredients;
        Ingredient[] tofuStirFryIngredients = SpicyIngredient.tofuStirFryIngredients;
    ...
    for (Ingredient ingredient : chickenCurryIngredients) {
    ...
    for (Ingredient ingredient : tofuStirFryIngredients) {
        if (allergenInput.equalsIgnoreCase(ingredient.getName())) {
    ...
    if (discardFirstDish && discardSecondDish) {
        ...
        jLabel3.setText("We recommend the dish: Tofu Stir-Fry");
    } else if (discardSecondDish) {
        // Second dish is discarded, recommend the first dish
        jLabel3.setText("We recommend the dish: Chicken Curry");
    } else {
        // Neither dish is discarded, recommend both dishes
        jLabel3.setText("Both dishes are suitable: Chicken Curry and Tofu Stir-Fry");
    }
}
